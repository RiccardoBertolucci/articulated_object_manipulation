...
def main():
	...
	while not rospy.is_shutdown():
		...
		os.system("rosrun baxter_examples joint_trajectory_file_playback_modified.py -f /home/roberto/catkin_ws/src/articulated_object_manipulation/actions/left_rotate_left_flat_down.rec")
		
		left.open([])
		
		os.system("rosrun baxter_examples joint_trajectory_file_playback_modified.py -f /home/roberto/catkin_ws/src/articulated_object_manipulation/actions/left_leave_left_down.rec")
