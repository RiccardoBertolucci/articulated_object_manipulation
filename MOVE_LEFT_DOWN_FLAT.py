...
def main():
	...
	while not rospy.is_shutdown():
		...
		os.system("rosrun baxter_examples joint_trajectory_file_playback_modified.py -f /home/roberto/catkin_ws/src/articulated_object_manipulation/actions/left_reach_left_down.rec")
		
		left.close([])
		
		os.system("rosrun baxter_examples joint_trajectory_file_playback_modified.py -f /home/roberto/catkin_ws/src/articulated_object_manipulation/actions/left_rotate_left_down_flat.rec")
